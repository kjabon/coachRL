# Adapted from Deepmind Acme's gym_wrapper.py
# Edited in order to support MultiDiscrete action spaces: see _convert_to_spec()
...
class GymWrapper(dm_env.Environment):
  ...
  def step(self, action: types.NestedArray) -> dm_env.TimeStep:
    ...
    action = self._environment.action_space.dtype.type(action)
